        ...
        <header className='w-full bg-white'>
            <div className='mx-auto flex h-20 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8'>
                ...
                <div className='flex gap-2 sm:gap-4'>
                    ...
                    <div className='flex h-11 w-11 items-center justify-center rounded-full bg-gray-200 text-lg text-gray-700 transition hover:scale-105 sm:h-[50px] sm:w-[50px] sm:text-[20px]'>
